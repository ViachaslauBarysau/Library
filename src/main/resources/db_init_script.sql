...
VALUES ('The Film Experience', 'Alpina', 2012, 512, '978-5-17-118208-3', 'Enjoy a more poignant film experience by diving' ||
       ...
       ('Dead Souls', 'Myth', 2008, 524, '0393934918', 'The story follows the exploits of Chichikov, a middle-aged ' ||
       ...
       ('Ruslan and Ludmila', 'Admire', 1998, 376, '1138743968', 'In a brief prologue, the narrator of the story ' ||
       ...
       ('Evenings on a Farm Near Dikanka', 'Peresvet', 2001, 636, '978-985-7143-55-9', 'Evenings on a Farm Near Dikanka is' ||
       ...
       ('Crime and Punishment', 'Alpina', 2004, 817, '978-5-9614-6799-4', 'Rodion Romanovich Raskolnikov, a former law ' ||
       ...
       ('The Idiot', 'Admire', 1998, 376, '978-5-9614-6535-8', 'Prince Myshkin, a young man in his mid-twenties and a ' ||
       ...
       ('Poems', 'Alpina', 2004, 322, '978-985-19-4527-2', 'Collection of poem written by Fyodor Tyutchev.', 6, 6),
       ('Romeo and Juliet', 'Peresvet', 2006, 914, '978-5-699-47515-5', 'Romeo and Juliet is a tragedy written by William ' ||
       ...
       ('The Book of Life', 'Romantic', 2009, 336, '978-5-17-080115-2', 'Bringing the magic and suspense of the' ||
       ...
       ('Migrations', 'Alpina', 2018, 817, '978-5-17-084593-4', 'Franny Stone has always been a wanderer. By following ' ||
       ...
       ('Vesper Flights', 'Alpina', 2018, 817, '978-5-04-112162-4', 'Vesper Flights is a book about observation, ' ||
...
VALUES ('Alexandr Kuznetsov', 'kuznetsov@gmail.com'),
       ('Polina Pavlova', 'pavlova@gmail.com'),
       ('Stanislav Sidorov', 'sidorov@gmail.com'),
       ('Ivan Ivanov', 'ivanov@gmail.com'),
       ('Svetlana Prokofeva', 'prokofeva@gmail.com'),
       ('Valerii Poloneichik', 'poloneichik@gmail.com'),
       ('Anton Antonov', 'antonov@gmail.com'),
       ('Viachaslau Borisov', 'borisov@gmail.com'),
       ('Elena Efremova', 'efremoav@gmail.com'),
       ('Sergei Alferov', 'alferov@gmail.com'),
       ('Petr Petrov', 'petrov@gmail.com'),
       ('Antonina Ivanova', 'ivanova2020@gmail.com');
...
INSERT INTO Books_Readers(Book_ID, Reader_ID, Borrow_date, Time_Period, Status, Due_date, Return_date)
VALUES (1, 1, '2019-11-27', 3, 'returned', '2020-02-27', '2019-12-31 16:24:00'),
       (1, 2, '2016-12-31', 6, 'returned', '2017-07-01', '2017-03-31 12:31:08'),
       (2, 3, '2015-01-04', 2, 'returned', '2015-03-04','2015-02-24 13:02:36'),
       (2, 4, '2020-06-01', 6, 'damaged', '2021-01-01', '2020-06-30 15:22:16'),
       (3, 5, '2019-11-16', 3, 'returned', '2020-02-16', '2019-12-24 16:02:12'),
       (3, 6, '2020-08-03', 1, 'lost', '2020-09-03', '2020-08-24 16:02:12'),
       (2, 2, '2019-08-21', 6, 'returned', '2020-02-21', '2019-08-31 12:03:31'),
       (6, 3, '2014-10-22', 3, 'lost', '2014-01-22', '2014-11-14 14:22:10'),
       (5, 1, '2018-01-29', 6, 'returned', '2018-07-29', '2018-04-16 14:04:44'),
       (8, 8, '2016-09-27', 3, 'returned', '2016-12-27', '2016-10-29 10:24:06');

INSERT INTO Books_Readers(Book_ID, Reader_ID, Borrow_date, Time_Period, Status, Due_date)
VALUES (5, 2, '2020-08-24', 3, 'borrowed', '2020-10-01'),
       (16, 1, '2020-08-21', 3, 'borrowed', '2020-11-21'),
       (1, 8, '2020-09-08', 3, 'borrowed', '2020-12-08'),
       (1, 3, '2020-07-10', 3, 'borrowed', '2020-10-10');
